...
class TermuxDeviceGenerator:
    """Générateur de device Android réel - Toujours nouveau pour chaque connexion"""
    ...
    def get_real_android_device_info():
            ...
            try:
                ...
                if 'Physical density:' in wm_density:
                    ...
                    if density_match:
                        ...
                        device_info['dpr'] = round(density / 160, 3)
            except:
                pass
        ...
        device_info['cpu'] = 'mt6989'  # CPU par défaut ou récupérer dynamiquement
        device_info['version_code'] = '370711637'
        ...
        device_info['user_agent_mobile'] = (
            f"Instagram 307.0.0.34.111 Android ({device_info['android_version']}/"
...
class InstagramSignup:
    ...
    def generate_device_info(self):
        """Générer des informations de device Android réalistes avec Chrome 135-141"""
        import random
        
        # Modèles de téléphones populaires
        devices = [
            {"model": "SM-G991B", "brand": "samsung", "manufacturer": "samsung", "device": "z3q", "android": "14"},
            {"model": "Pixel 7", "brand": "google", "manufacturer": "Google", "device": "panther", "android": "14"},
            {"model": "SM-A54", "brand": "samsung", "manufacturer": "samsung", "device": "a54x", "android": "13"},
            {"model": "Redmi Note 12", "brand": "xiaomi", "manufacturer": "Xiaomi", "device": "sapphire", "android": "13"},
            {"model": "POCO F5", "brand": "xiaomi", "manufacturer": "Xiaomi", "device": "mondrian", "android": "13"},
            {"model": "OnePlus 11", "brand": "oneplus", "manufacturer": "OnePlus", "device": "salami", "android": "14"},
            {"model": "SM-S908B", "brand": "samsung", "manufacturer": "samsung", "device": "dm1q", "android": "14"},
            {"model": "Pixel 8", "brand": "google", "manufacturer": "Google", "device": "shiba", "android": "14"},
            {"model": "Mi 13", "brand": "xiaomi", "manufacturer": "Xiaomi", "device": "fuxi", "android": "13"},
            {"model": "Find X6", "brand": "oppo", "manufacturer": "OPPO", "device": "oplus2309", "android": "13"}
        ]
        ...
        self.device_info = {
            ...
            "sdk_version": "34" if device["android"] == "14" else "33",
            "screen_width": random.randint(380, 450),
            "screen_height": random.randint(800, 950),
            "dpr": round(random.uniform(2.0, 3.5), 3),
            "platform_version": f"{device['android']}.0.0"
        }
        
        # User-Agent Web avec versions Chrome 135-141 réelles
        chrome_versions = [
            # Chrome 141
            "141.0.7390.123", "141.0.7390.132", "141.0.7390.98", "141.0.7390.87",
            # Chrome 140  
            "140.0.7339.128", "140.0.7339.102", "140.0.7339.89", "140.0.7339.76",
            # Chrome 139
            "139.0.7327.127", "139.0.7327.115", "139.0.7327.98", "139.0.7327.87",
            # Chrome 138
            "138.0.7262.145", "138.0.7262.132", "138.0.7262.105", "138.0.7262.89",
            # Chrome 137
            "137.0.7189.154", "137.0.7189.143", "137.0.7189.128", "137.0.7189.102",
            # Chrome 136
            "136.0.7156.178", "136.0.7156.165", "136.0.7156.154", "136.0.7156.132",
            # Chrome 135
            "135.0.7098.193", "135.0.7098.182", "135.0.7098.165", "135.0.7098.154"
        ]
        chrome_version = random.choice(chrome_versions)
        
        self.device_info['user_agent'] = (
            f"Mozilla/5.0 (Linux; Android {self.device_info['android_version']}; "
            f"{self.device_info['model']}) AppleWebKit/537.36 (KHTML, like Gecko) "
    ...
    def get_base_headers(self):
        ...
        # Version complète pour sec-ch-ua-full-version-list
        full_chrome_version = ""
        if "Chrome/" in user_agent:
            try:
                full_chrome_version = user_agent.split("Chrome/")[1].split(" ")[0]
            except:
                full_chrome_version = "141.0.7390.123"
        
        return {
            "host": "www.instagram.com",
            "connection": "keep-alive",
            "sec-ch-ua-full-version-list": f'"Google Chrome";v="{full_chrome_version}", "Not?A_Brand";v="8.0.0.0", "Chromium";v="{full_chrome_version}"',
            "sec-ch-ua": f'"Google Chrome";v="{chrome_version}", "Not?A_Brand";v="8", "Chromium";v="{chrome_version}"',
            "sec-ch-ua-mobile": "?1",
            "sec-ch-ua-platform": '"Android"',
            "sec-ch-ua-platform-version": f'"{self.device_info.get("platform_version", "14.0.0")}"',
